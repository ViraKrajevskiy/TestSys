...
(function () {
  const DICT = {
    ru: {
      ...
      sidebarLeftDesc: "Обычная колонка слева, ширину можно тянуть",
      sidebarRightDesc: "То же самое, но колонка справа",
      sidebarFloatingDesc: "Панель поверх контента — запросу достаётся вся ширина",
      sidebarToggleHint: "Скрыть панель целиком — кнопка слева от логотипа",
      ...
      hkGroup_gen: "Генерация данных",
      hkRandomizer: "Рандомайзер", hkGenerator: "Генератор тестовых данных",
      ...
      hkSaveRequest: "Сохранить запрос в коллекцию",
      hkSearchResponse: "Поиск по ответу",
    ...
    en: {
      ...
      sidebarPosition: "Panel position",
      sidebarLeftDesc: "Regular column on the left, resizable",
      sidebarRightDesc: "Same, but on the right",
      sidebarFloatingDesc: "Floats above content — the request gets full width",
      sidebarToggleHint: "Hide the panel entirely — button left of the logo",
      ...
      hkGroup_gen: "Data generation",
      hkRandomizer: "Randomizer", hkGenerator: "Test data generator",
      hkNewTab: "New tab", hkCloseTab: "Close tab",
      hkNextTab: "Next tab", hkPrevTab: "Previous tab",
      hkSendRequest: "Send request",
      hkSaveRequest: "Save request to collection",
      hkSearchResponse: "Search in response",
    ...
    uz: {
      ...
      sidebarPosition: "Panel joylashuvi",
      sidebarLeftDesc: "Chapdagi oddiy ustun, kengligini o\'zgartirish mumkin",
      sidebarRightDesc: "Xuddi shunday, lekin o\'ngda",
      sidebarFloatingDesc: "Panel kontent ustida — so\'rovga to\'liq kenglik",
      sidebarToggleHint: "Panelni butunlay yashirish — logotip chapidagi tugma",
      ...
      hkGroup_gen: "Ma'lumot generatsiyasi",
      hkRandomizer: "Randomayzer", hkGenerator: "Test ma'lumot generatori",
      ...
      hkSaveRequest: "So'rovni to'plamga saqlash",
      hkSearchResponse: "Javobda qidirish",
